...
namespace ERecruitment.Core.Common
{
    ...
    public class SingletonList<T> : Singleton<IList<T>>
    {
        ...
        /// <summary>
        ///     The singleton instance for the specified type T. O
        ///     nly one instance (at the time) of this list for each type of T.
        /// </summary>
    ...
    public class SingletonDictionary<TKey, TValue> : Singleton<IDictionary<TKey, TValue>>
    {
        ...
        /// <summary>
        ///     The singleton instance for the specified type T.
        ///     Only one instance (at the time) of this dictionary for each type of T.
        /// </summary>
