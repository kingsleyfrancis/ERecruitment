    ...
    public class WebHelper : IWebHelper
    {
        ...
        public virtual string GetCurrentIpAddress()
        {
            try
            {
                ...
                {
                    string ip = _httpContext.Request.ClientIpFromRequest(true);
                    return ip;
                }
        ...
        public bool IsDefaultIp(string ipAddress)
        {
            ...
            bool result = defaultIp.Equals(ipAddress, StringComparison.InvariantCultureIgnoreCase);
            return result;
        }
        ...
        /*public virtual string GetStoreHost(bool useSsl)
        {
            ...
            if (DataSettingsHelper.DatabaseIsInstalled())
            {
                ...
                if (currentStore == null)
                    throw new JobateaseException("Current store cannot be loaded");
                ...
                #endregion Database is installed
            }
            else
            {
        ...
        ///     needn't be processed by the cms engine.
        /// </summary>
        ...
        public virtual string ModifyQueryString(string url, string queryStringModification, string anchor)
        {
            ...
            return (url + (string.IsNullOrEmpty(str) ? "" : ("?" + str)) +
                    (string.IsNullOrEmpty(str2) ? "" : ("#" + str2))).ToLowerInvariant();
        }
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new Exception(
                        ...
                        Environment.NewLine + "- run the application in a full trust environment, or" +
                        Environment.NewLine + "- give the application write access to the 'web.config' file.");
                }
            ...
            if (_httpContext != null && makeRedirect)
            {
                if (!String.IsNullOrEmpty(redirectUrl))
                    //redirectUrl = GetThisPageUrl(true); // Edited this section
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                return _httpContext.Items["Best.IsPOSTBeingDone"] != null &&
                       Convert.ToBoolean(_httpContext.Items["Best.IsPOSTBeingDone"]);
            }
            set { _httpContext.Items["Best.IsPOSTBeingDone"] = value; }
        }
        ...
        private bool TryWriteGlobalAsax()
        {
            try
            {
                ...
                File.SetLastWriteTimeUtc(MapPath("~/global.asax"), DateTime.Now);
                return true;
            }
            catch
            {
