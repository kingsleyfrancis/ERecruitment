...
namespace ERecruitment.Data
{
    public class Repository<TEntity> :
        IRepositoryAsync<TEntity> where TEntity : class, IEntity
    {
        ...
        private HashSet<object> _entitesChecked;
            // tracking of all process entities in the object graph when calling SyncObjectGraph
            ...
            catch (DbEntityValidationException dbEx)
            {
                ...
                foreach (DbEntityValidationResult validationErrors in dbEx.EntityValidationErrors)
                    msg = validationErrors.ValidationErrors
                        .Aggregate(msg, (current, validationError) =>
                ...
                //Log to local file
                CommonHelper.LogFatalErrors(fail);
